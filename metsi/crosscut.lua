...
local pcls = {1,   1,   1,   1,   2,   3}
local ptop = {160, 160, 160, 160, 70,  10}
local plen = {370, 400, 430, 460, 300, 130}
local pval = {55,  57,  59,  59,  17,  5}
local M    =  1 +  1 +  1 +  1 +  1 +  1
local NAS  =  1 +                 1 +  1
...
-- plen   = P[,3]
-- pval   = P[,4]
local function apt(spe, d, h, div)
	local div1 = 1/div
